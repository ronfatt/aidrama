...
const metadataSchema = z.object({
  scenes: z.array(
    z.object({
      ...
      cameraStyle: z.string().trim().min(1).optional().or(z.literal("")),
      actionStyle: z.string().trim().min(1).optional().or(z.literal("")),
      motionTemplateId: z.string().trim().min(1).optional().or(z.literal("")),
