...
`GEMINI_IMAGE_MODEL` is optional. If omitted, the app defaults to `gemini-2.5-flash-image`.
`GEMINI_IMAGE_FALLBACK_MODEL` is optional. If omitted, the app falls back to `gemini-3-pro-image-preview` when primary model fails.
